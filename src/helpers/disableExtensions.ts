// These are extensions that are known to interfere with the operation of GPTsMotion.
// We'll turn them off temporarily while GPTsMotion is performing actions.
